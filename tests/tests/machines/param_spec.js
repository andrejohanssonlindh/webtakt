...
const EXPECTED = {
  synth: [
    { path: 'osc.waveform',  label: 'Waveform',     type: 'enum',   options: ['sine','sawtooth','square','triangle'], group: 'OSC', plockMode: 'js' },
  ...
  snare: [
    ...
    { path: 'decay',        label: 'Decay',     type: 'number', min: 0.05, max: 1.0,  default: 0.18, group: 'TONE', plockMode: 'js' },
  ...
  chord: [
    { path: 'osc.detune',   label: 'Detune',    type: 'number', min: -100, max: 100, default: 0,   modulatable: true, lfoMin: -100, lfoMax: 100, plockMode: 'audioParam', hidden: true },
    { path: 'chord',        label: 'Chord',     type: 'enum',   options: ['major','minor','dom7','maj7','min7','sus2','sus4','dim','aug','power','octave'], group: 'CHORD', plockMode: 'js' },
  ...
  'kick.silk': [
    ...
    { path: 'decay',        label: 'Decay',       type: 'number', min: 0.05, max: 2.0, default: 0.45, group: 'TONE', plockMode: 'js' },
  ...
  'kick.hard': [
    ...
    { path: 'decay',        label: 'Decay',       type: 'number', min: 0.05, max: 2.0, default: 0.45, group: 'TONE', plockMode: 'js' },
    { path: 'sweep',        label: 'Sweep',       type: 'number', min: 1, max: 8, default: 4.0, group: 'TONE', plockMode: 'js' },
    { path: 'sub.level',    label: 'Sub',         type: 'number', min: 0, max: 1, default: 0.8, group: 'TONE', plockMode: 'js' },
  ...
  'kick.analogue': [
    ...
    { path: 'decay',        label: 'Decay',       type: 'number', min: 0.05, max: 2.0, default: 0.50, group: 'TONE', plockMode: 'js' },
    { path: 'sweep',        label: 'Sweep',       type: 'number', min: 1, max: 8, default: 4.0, group: 'TONE', plockMode: 'js' },
    { path: 'sub.level',    label: 'Sub',         type: 'number', min: 0, max: 1, default: 0.8, group: 'TONE', plockMode: 'js' },
    { path: 'drive',        label: 'Drive',       type: 'number', min: 1, max: 6, default: 2.5, group: 'TONE', plockMode: 'js' },
  ...
  hihat: [
    ...
    { path: 'open.decay',   label: 'Open Decay', type: 'number', min: 0.1, max: 2.0, default: 0.5, group: 'DECAY', plockMode: 'js' },
    { path: 'open',         label: 'Open',       type: 'boolean', default: false, group: 'DECAY', plockMode: 'js' },
  ...
  cymbal: [
    ...
    { path: 'tone',         label: 'Tone',       type: 'number', min: 200, max: 8000, default: 1500, modulatable: true, lfoMin: 200, lfoMax: 8000, group: 'TONE', plockMode: 'audioParam' },
    { path: 'body',         label: 'Body',       type: 'number', min: 500, max: 16000, default: 3500, modulatable: true, lfoMin: 500, lfoMax: 16000, group: 'TONE', plockMode: 'audioParam' },
    { path: 'resonance',    label: 'Resonance',  type: 'number', min: 0.5, max: 12, default: 3.0, modulatable: true, lfoMin: 0.5, lfoMax: 12, group: 'TONE', plockMode: 'audioParam' },
    { path: 'decay',        label: 'Decay',      type: 'number', min: 0.05, max: 0.5, default: 0.15, group: 'DECAY', plockMode: 'js' },
  ...
  'tom.analogue': [
    ...
    { path: 'sweep',        label: 'Sweep',     type: 'number', min: 1, max: 4, default: 1.8, group: 'TONE', plockMode: 'js' },
    { path: 'drive',        label: 'Drive',     type: 'number', min: 1, max: 4, default: 1.8, group: 'TONE', plockMode: 'js' },
    { path: 'drift',        label: 'Drift',     type: 'number', min: 0, max: 1, default: 0.4, group: 'TONE', plockMode: 'js' },
  ...
  noise: [
    ...
    { path: 'body.freq',    label: 'Body Freq',  type: 'number', min: 80, max: 2000, default: 400, modulatable: true, lfoMin: 80, lfoMax: 2000, group: 'BODY', plockMode: 'audioParam' },
    { path: 'body.level',   label: 'Body',       type: 'number', min: 0, max: 1, default: 0.5, modulatable: true, lfoMin: 0, lfoMax: 1, group: 'BODY', plockMode: 'audioParam' },
  ...
  karplus: [
    ...
    { path: 'feedback',     label: 'Feedback',    type: 'number', min: 0.8, max: 0.999, default: 0.985, group: 'STRING', plockMode: 'js' },
  ...
  comb: [
    ...
    { path: 'decay',        label: 'Decay',   type: 'number', min: 0.1, max: 8, default: 1.8, modulatable: true, lfoMin: 0.1, lfoMax: 8, group: 'TUBE', plockMode: 'js' },
  ...
  marimba: [
    ...
    { path: 'decay2',       label: 'Decay 2',     type: 'number', min: 0.05, max: 2.0, default: 0.18, group: 'DECAY', plockMode: 'js' },
    { path: 'decay3',       label: 'Decay 3',     type: 'number', min: 0.01, max: 0.5, default: 0.05, group: 'DECAY', plockMode: 'js' },
    { path: 'p2ratio',      label: 'P2 Ratio',    type: 'number', min: 2.0, max: 6.0, default: 3.9, modulatable: true, lfoMin: 2.0, lfoMax: 6.0, group: 'PARTIALS', plockMode: 'audioParam' },
    { path: 'p3ratio',      label: 'P3 Ratio',    type: 'number', min: 5.0, max: 15.0, default: 9.9, modulatable: true, lfoMin: 5.0, lfoMax: 15.0, group: 'PARTIALS', plockMode: 'audioParam' },
    { path: 'p2level',      label: 'P2 Level',    type: 'number', min: 0, max: 1, default: 0.45, group: 'PARTIALS', plockMode: 'js' },
  ...
  transient: [
    ...
    { path: 'pitch.end',    label: 'Pitch End',   type: 'number', min: 0.05, max: 1.0, default: 0.4, group: 'BODY', plockMode: 'js' },
    { path: 'body.decay',   label: 'Body Decay',  type: 'number', min: 0.01, max: 2.0, default: 0.12, group: 'BODY', plockMode: 'js' },
    { path: 'body.wave',    label: 'Body Wave',   type: 'enum',   options: ['sine','triangle'], group: 'BODY', plockMode: 'js' },
  ...
  wood: [
    ...
    { path: 'freq2',        label: 'Freq 2',     type: 'number', min: 400, max: 8000, default: 1400, modulatable: true, lfoMin: 400, lfoMax: 8000, group: 'RESONATOR', plockMode: 'audioParam' },
    { path: 'ring',         label: 'Ring',       type: 'number', min: 1, max: 30, default: 12, modulatable: true, lfoMin: 1, lfoMax: 30, group: 'RESONATOR', plockMode: 'audioParam' },
    { path: 'mix',          label: 'Mix',        type: 'number', min: 0, max: 1, default: 0.35, group: 'RESONATOR', plockMode: 'js' },
    { path: 'note.track',   label: 'Note Track', type: 'boolean', default: false, group: 'RESONATOR', plockMode: 'js' },
  ...
  bass: [
    { path: 'osc.detune',   label: 'Detune',    type: 'number', min: -100, max: 100,  default: 0,    modulatable: true, lfoMin: -100, lfoMax: 100, plockMode: 'audioParam', hidden: true },
    { path: 'waveform',     label: 'Waveform',  type: 'enum',   options: ['sawtooth','square'],                                     group: 'OSC',    plockMode: 'js'        },
    { path: 'sub.level',    label: 'Sub',       type: 'number', min: 0,    max: 1,    default: 0.4,  modulatable: true, lfoMin: 0,    lfoMax: 1,   group: 'OSC',    plockMode: 'audioParam' },
  ...
  swarm: [
    ...
    { path: 'osc.detune',   label: 'Detune',     type: 'number', min: -100, max: 100, default: 0,    modulatable: true, lfoMin: -100, lfoMax: 100, plockMode: 'audioParam', hidden: true },
    { path: 'spread',       label: 'Spread',     type: 'number', min: 0,    max: 100, default: 15,                                 group: 'SWARM',  plockMode: 'js'        },
    { path: 'height',       label: 'Height',     type: 'number', min: 0,    max: 1,   default: 0.7,  modulatable: true, lfoMin: 0,    lfoMax: 1,   group: 'SWARM',  plockMode: 'audioParam' },
  ...
  strings: [
    ...
    { path: 'osc.detune',   label: 'Detune',   type: 'number', min: -100, max: 100, default: 0,    modulatable: true, lfoMin: -100, lfoMax: 100, plockMode: 'audioParam', hidden: true },
    { path: 'ensemble',     label: 'Ensemble', type: 'number', min: 0,    max: 60,  default: 14,   modulatable: true, lfoMin: 0,    lfoMax: 60,   group: 'VOICE', plockMode: 'js'        },
    { path: 'tone',         label: 'Tone',     type: 'number', min: 300,  max: 12000, default: 4000, modulatable: true, lfoMin: 300,  lfoMax: 12000, group: 'TONE', plockMode: 'audioParam' },
    { path: 'body',         label: 'Body',     type: 'number', min: 150,  max: 3000, default: 800,  modulatable: true, lfoMin: 150,  lfoMax: 3000, group: 'TONE', plockMode: 'audioParam' },
    { path: 'resonance',    label: 'Resonance',type: 'number', min: 0.3,  max: 10,   default: 1.2,  modulatable: true, lfoMin: 0.3,  lfoMax: 10,   group: 'TONE', plockMode: 'audioParam' },
    { path: 'bow',          label: 'Bow',      type: 'number', min: 0,    max: 1,    default: 0.15, modulatable: true, lfoMin: 0,    lfoMax: 1,    group: 'TONE', plockMode: 'audioParam' },
    { path: 'vibrato',      label: 'Vibrato',  type: 'number', min: 0,    max: 50,   default: 6,    modulatable: true, lfoMin: 0,    lfoMax: 50,   group: 'VIBRATO', plockMode: 'audioParam' },
  ...
  moogish: [
    ...
    { path: 'osc2.level',    label: 'O2 Level',  type: 'number', min: 0,   max: 1,   default: 0.45, modulatable: true, lfoMin: 0,   lfoMax: 1,  group: 'OSC 2', plockMode: 'audioParam' },
    { path: 'osc3.waveform', label: 'O3 Wave',   type: 'enum',   options: ['saw','square','triangle','pulse','sine'], group: 'OSC 3', plockMode: 'js' },
    { path: 'osc3.octave',   label: 'O3 Oct',    type: 'number', min: -2,  max: 2,   default: -1,   group: 'OSC 3', plockMode: 'js' },
    { path: 'osc3.detune',   label: 'O3 Detune', type: 'number', min: -50, max: 50,  default: 2,    modulatable: true, lfoMin: -50, lfoMax: 50, group: 'OSC 3', plockMode: 'audioParam' },
  ...
  juno: [
    ...
    { path: 'octave',        label: 'Octave',    type: 'number', min: -2,  max: 2,   default: 0,    group: 'OSC', plockMode: 'js' },
    { path: 'detune',        label: 'Detune',    type: 'number', min: -50, max: 50,  default: 0,    modulatable: true, lfoMin: -50, lfoMax: 50, group: 'OSC', plockMode: 'audioParam' },
    { path: 'sub.level',     label: 'Sub',       type: 'number', min: 0,   max: 1,   default: 0.3,  modulatable: true, lfoMin: 0,   lfoMax: 1,  group: 'TEXTURE', plockMode: 'audioParam' },
    { path: 'sub.waveform',  label: 'Sub Wave',  type: 'enum',   options: ['square','triangle','sine'], group: 'TEXTURE', plockMode: 'js' },
    { path: 'noise.level',   label: 'Noise',     type: 'number', min: 0,   max: 1,   default: 0.0,  modulatable: true, lfoMin: 0,   lfoMax: 1,  group: 'TEXTURE', plockMode: 'audioParam' },
  ...
  oberish: [
    { path: 'osc1.waveform', label: 'O1 Wave',   type: 'enum',   options: ['saw','square','triangle','pulse','sine'], group: 'OSC 1', plockMode: 'js' },
    { path: 'osc1.octave',   label: 'O1 Oct',    type: 'number', min: -2,  max: 2,   default: 0,    group: 'OSC 1', plockMode: 'js' },
    { path: 'osc1.detune',   label: 'O1 Detune', type: 'number', min: -50, max: 50,  default: -8,   modulatable: true, lfoMin: -50, lfoMax: 50, group: 'OSC 1', plockMode: 'audioParam' },
    { path: 'osc1.level',    label: 'O1 Level',  type: 'number', min: 0,   max: 1,   default: 0.5,  modulatable: true, lfoMin: 0,   lfoMax: 1,  group: 'OSC 1', plockMode: 'audioParam' },
    { path: 'osc2.waveform', label: 'O2 Wave',   type: 'enum',   options: ['saw','square','triangle','pulse','sine'], group: 'OSC 2', plockMode: 'js' },
    { path: 'osc2.octave',   label: 'O2 Oct',    type: 'number', min: -2,  max: 2,   default: 0,    group: 'OSC 2', plockMode: 'js' },
    { path: 'osc2.detune',   label: 'O2 Detune', type: 'number', min: -50, max: 50,  default: 9,    modulatable: true, lfoMin: -50, lfoMax: 50, group: 'OSC 2', plockMode: 'audioParam' },
    { path: 'osc2.level',    label: 'O2 Level',  type: 'number', min: 0,   max: 1,   default: 0.5,  modulatable: true, lfoMin: 0,   lfoMax: 1,  group: 'OSC 2', plockMode: 'audioParam' },
    { path: 'spread',        label: 'Spread',    type: 'number', min: 0,   max: 50,  default: 12,   modulatable: true, lfoMin: 0,   lfoMax: 50, group: 'TEXTURE', plockMode: 'js' },
    { path: 'noise.level',   label: 'Noise',     type: 'number', min: 0,   max: 1,   default: 0.0,  modulatable: true, lfoMin: 0,   lfoMax: 1,  group: 'TEXTURE', plockMode: 'audioParam' },
  ...
  fold: [
    ...
    { path: 'octave',        label: 'Octave',    type: 'number', min: -2,  max: 2,   default: 0,    group: 'OSC', plockMode: 'js' },
    { path: 'detune',        label: 'Detune',    type: 'number', min: -50, max: 50,  default: 0,    modulatable: true, lfoMin: -50, lfoMax: 50, group: 'OSC', plockMode: 'audioParam' },
    { path: 'fold',          label: 'Fold',      type: 'number', min: 0,   max: 1,   default: 0.3,  modulatable: true, lfoMin: 0,   lfoMax: 1,  group: 'FOLD', plockMode: 'js' },
    { path: 'symmetry',      label: 'Sym',       type: 'number', min: -1,  max: 1,   default: 0,    modulatable: true, lfoMin: -1,  lfoMax: 1,  group: 'FOLD', plockMode: 'audioParam' },
    { path: 'timbre',        label: 'Timbre',    type: 'number', min: 0,   max: 1,   default: 0.0,  modulatable: true, lfoMin: 0,   lfoMax: 1,  group: 'FM', plockMode: 'js' },
...
const RESOLVES = {
  ...
  juno: ['detune', 'sub.level', 'noise.level', 'osc.detune', 'output.level'],
  oberish: ['osc1.detune', 'osc1.level', 'osc2.detune', 'osc2.level', 'noise.level', 'osc.detune', 'output.level'],
  fold: ['detune', 'symmetry', 'osc.detune', 'output.level'],
...
suite('Param spec (declarative machines)', () => {
  ...
  for (const type of [
    ...
    'bass', 'swarm', 'strings', 'moogish', 'juno', 'oberish', 'fold', 'sampler',
  ]) {
