...
export class ChordMachine extends Machine {
  ...
  static SPEC = {
    ...
    'chord':        { label: 'Chord', type: 'enum', options: CHORD_NAMES, default: 'major', group: 'CHORD',
                      plockMode: 'js', apply: (v, t, m) => m._applyChord(m._rootFreq, t) },
    'inversion':    { label: 'Inversion', type: 'number', min: 0, max: 3, default: 0, group: 'CHORD',
                      plockMode: 'js', apply: (v, t, m) => m._applyChord(m._rootFreq, t) },
    'spread':       { label: 'Spread', type: 'number', min: 0, max: 50, default: 8, group: 'CHORD',
