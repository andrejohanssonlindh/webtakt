...
export class CymbalMachine extends Machine {
  ...
  static SPEC = {
    'tune':         { label: 'Tune', type: 'number', min: 100, max: 800, default: 300,
    ...
    'tone':         { label: 'Tone', type: 'number', min: 200, max: 8000, default: 1500,
                      modulatable: true, lfoMin: 200, lfoMax: 8000,
                      target: m => m._hpf.frequency, schedule: 'setTarget', tc: 0.01 },
    'body':         { label: 'Body', type: 'number', min: 500, max: 16000, default: 3500,
                      modulatable: true, lfoMin: 500, lfoMax: 16000,
                      target: m => m._bp.frequency, schedule: 'setTarget', tc: 0.01 },
    'resonance':    { label: 'Resonance', type: 'number', min: 0.5, max: 12, default: 3.0,
                      modulatable: true, lfoMin: 0.5, lfoMax: 12,
                      target: m => m._bp.Q, schedule: 'setTarget', tc: 0.01 },
    'decay':        { label: 'Decay', type: 'number', min: 0.05, max: 0.5, default: 0.15, plockMode: 'js' },
    'mid.decay':    { label: 'Mid Decay', type: 'number', min: 0.1, max: 2.0, default: 0.6, plockMode: 'js' },
    'open.decay':   { label: 'Open Decay', type: 'number', min: 0.5, max: 8.0, default: 2.5, plockMode: 'js' },
    'mode':         { label: 'Mode', type: 'enum', options: ['closed','mid','open'], default: 'closed', plockMode: 'js' },
